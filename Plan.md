...
#### 17. Сценарий ввода цифр в поле 'Владелец'.
Шаги воспроизведения:
1. Нажать кнопку "Купить";
...
#### 18. Сценарий ввода спецсимволов в поле 'Владелец'.
Шаги воспроизведения:
1. Нажать кнопку "Купить";
...
#### 19. Сценарий отправки формы с истекшим сроком действия карты.
Шаги воспроизведения:
1. Нажать кнопку "Купить";
2. Заполнить форму тестовыми данными:
...
#### 20. Сценарий отправки формы со сроком действия карты позже текущей даты на 5 лет.
Шаги воспроизведения:
1. Нажать кнопку "Купить";
2. Заполнить форму тестовыми данными:
- Номер карты: 4444 4444 4444 4441 (операции по этой карте проходят со статусом "APPROVED");
